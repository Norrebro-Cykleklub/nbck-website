...
export default function AboutUsSection() {
  const openBylaws = (event: OnClickAnchorEvent) => {};
  const openRegulations = (event: OnClickAnchorEvent) => {};
      ...
      <div className="container">
        ...
        <div className="row text-center">
          <div className="col-md-6 kontaktOsSection">
            ...
            <p className="text-muted">
              Vi vil meget gerne høre fra dig, hvis du har spørgsmål eller noget
              andet på hjerte. Åben kontakt formularen her:
            </p>
