          ...
          <div className="col-lg-10 mx-auto">
            <div id="nbroModalBody" className="modal-body">
              <div className="reglementContent">
                ...
                <ul>
                  <li>
                    <strong>Spænder hjelmen.</strong> Vi kører selvfølgelig
                    altid med hjelm.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Viser hensyn</strong> til vores medtrafikanter. Her
                    er det er god stil at køre med ringeklokke til træning.
                  </li>
                  <li>
                    <strong>Passer på hinanden.</strong> Vi udviser særligt
                    hensyn til klubbens andre medlemmer – både nye og erfarne.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Råber ikke ukvemsord</strong> eller udviser fagter
                    af andre trafikanter såvel som klubbens egne medlemmer -
                    også selvom man føler sig forurettet. Et lille vink er
                    selvfølgelig okay, men ingen langemand.
                  </li>
                  <li>
                    ...
                    eller et interval, hvilket som udgangspunkt sker efter
                    aftale i gruppen eller med dagens
                    kaptajn/træningsansvarlige.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Nørrebro CK er ren</strong> og tager afstand fra
