          ...
          <div className="col-lg-10 mx-auto">
            <div id="nbroModalBody" className="modal-body">
              <div className="privatlivspolitikContent">
                ...
                (legitime) interesser. Vi behandler kun personoplysninger, der
                er relevante og nødvendige til opfyldelse af de angivne formål,
                og vi sletter dine oplysninger, når de ikke længere er
                nødvendige.
                <br />
                <br />
                ...
                <ul>
                  ...
                  <li>
                    Som led i foreningens idrætsaktiviteter og andre
                    aktiviteter, herunder planlægning, gennemførelse og
                    opfølgning
                  </li>
                ...
                <ul>
                  ...
                  <li>
                    Opfyldelse af medlemspligter, herunder opkrævning og
                    betaling af kontingent m.v.
                  </li>
                  <li>
                  ...
                  <li>
                    Brug af situationsbilleder taget i foreningen, der afbilder
                    en konkret aktivitet eller situation i foreningen
                  </li>
                  <li>
                ...
                på et andet lovligt grundlag end samtykke. Vi indhenter derfor
                kun dit samtykke, når det i sjældne tilfælde er nødvendigt for
                at behandle dine personoplysninger til de formål, der er
                beskrevet ovenfor.
                <br />
                <br />
                Hvis vi indhenter dit samtykke, er det frivilligt, om du vil
                give samtykke, og du kan til enhver tid trække det tilbage ved
                ...
                pågældende personoplysninger. Hvis ikke, indhenter vi samtykke
                ...
                medlemskabets ophør og i overensstemmelse med følgende
                kriterier:
                <ul>
                  <li>
                    Af praktiske og administrative hensyn opbevarer vi dine
                ...
                Du har en række særlige rettigheder efter
                persondataforordningen, når vi behandler personoplysninger om
                dig:
                <ul>
                ...
                Du kan gøre brug af dine rettigheder, herunder gøre indsigelse
                mod vores behandling, ved at henvende dig til os. Vores
                ...
                betingelserne er opfyldt, og gennemfører i så fald ændringer
                ...
                gældende privatlivspolitik vil være tilgængelig på vores
                websted. Ved væsentlige ændringer vil du modtage meddelelse
                herom.
                <p></p>
              </div>
              {closeButton}
